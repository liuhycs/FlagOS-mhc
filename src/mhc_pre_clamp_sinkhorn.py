...
def mhc_pre_clamp_sinkhorn(
    ...
    # heavy GEMM offloaded to torch.mm; keep fp32 accum
    ...
    grid_c = lambda META: (T, triton.cdiv(D, META["BLOCK_D"]))
    _y_scale_kernel_hc4[grid_c](xf, pre, y, D=D)
